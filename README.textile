...
* The interior content's width + padding-left + padding-right + margin-left + margin-right must equal the slider's width.
* The interior content's height + padding-top + padding-bottom + margin-top + margin-bottom must equal the slider's height.
...
* When using the "fader" effect (sliderType:fader) with non-image content, you will want some kind of non-transparent background (either a non-transparent background-image or a solid background-color) otherwise the fade will look bad.
