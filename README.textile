...
* Each piece of interior content must have it's width + padding-left + padding-right + margin-left + margin-right equal to the slider's width.
* Each piece of interior content must have it's height + padding-top + padding-bottom + margin-top + margin-bottom equal the slider's height.
